...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title">Vehicle - Customs clearing and delivery</h4>
        <form method="POST" action="{{ route('client.services.vehiclesDeliver.store') }}" class="forms-sample" 
        ...
        @csrf
            ...
            <div class="form-group">
                <input type="hidden" class="form-control" id="service_category" name="service_category" value="Clearing and delivery" readonly>
            </div>
            <div class="form-group">
